        ...
        <>
            <nav className="container h-20 flex items-center justify-between mb-10 px-3">
                ...
                <div className="flex gap-2 items-center " >
                    ...
                    {
                        localStorage.getItem('token') ?<button onClick={()=>{localStorage.removeItem('token')
                        navigate(0)}}>Log out</button> : <NavLink to="/login">
            ...
            <div className=" items-center w-2/3 justify-between mx-10 hidden lg:flex md:mx-auto mb-16">
